...
<!-- header part Kids-->
    ...
    <header>
        ...
        <nav class="navbar">
            ...
            <ul class="menus">
                ...
                <li><a href="kids.php" class="menus-link active">Kids</a></li>
    ...
    <div class="coupon">
        ...
        <h3 style="font-family: paragraph;">#Kids</h3>
...
$selectquery = "SELECT * FROM kids_products";
...
<!-- Kids card End-->
    ...
    <form method="GET" action="http://localhost/php/levelup/kids.php">
