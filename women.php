...
<!-- header part Women-->
    ...
    <header>
        ...
        <nav class="navbar">
            ...
            <ul class="menus">
                ...
                <li><a href="women.php" class="menus-link active">Women</a></li>
    ...
    <div class="coupon">
        ...
        <h3 style="font-family: paragraph;">#Women</h3>
    ...
    <div class="men-products">
     ...
     <!-- Women Card Start-->
        ...
        <?php
            ...
            $selectquery = "SELECT * FROM women_products";
...
<!-- Women card End-->
    ...
    <form method="GET" action="http://localhost/php/levelup/women.php">
